...
shortDescription: "Cloud-native workplace management dashboard with Amazon Bedrock AI assistant, real-time employee analytics, attendance,leave,device,department & worklog tracking, and Cognito auth."
technologies: ["Next.js", "AWS Amplify Gen 2", "Amazon Bedrock","TypeScript", "DynamoDB", "Cognito","SES","SQS", "GraphQL"]

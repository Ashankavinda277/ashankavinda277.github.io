...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_D0unqLei.mjs';
import { manifest } from './manifest_BbCMHoZl.mjs';
...
const _args = {
    "middlewareSecret": "2601d6c4-d4f1-47f4-bfea-4fbe7d3ef19a",
